...
public:
    ...
    enum Flag {
        ...
        Flag_AutoHideSupport = 0x4000, ///> Supports minimizing dock widgets to the side-bar
    ...
    ///@brief Returns whether minimizing dock widgets to a side-bar is supported
    bool supportsAutoHide() const;
